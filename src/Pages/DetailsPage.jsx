...
const DetailsPage = () => {
  ...
  return (
    <>
    <div className='flex flex-col items-center justify-center gap-15 mt-10 h-screen'>
    <h1 className='text-[#0C0D4D] text-4xl font-bold'>Why MealMate?</h1>
...
SmartEats takes the guesswork out of nutrition, helping you thrive on your health journey.</p>
    <div className="bg-white flex flex-row gap-10 m-5 items-center justify-center">
